...
export const PRODUCT_DETAILS_STOP = "PRODUCT_DETAILS_STOP";
...
export const SIZE_DETAILS_STOP = "SIZE_DETAILS_STOP";
...
export const ORDER_CHECK_REQUEST = "ORDER_CHECK_REQUEST";
export const ORDER_CHECK_SUCCESS = "ORDER_CHECK_SUCCESS";
export const ORDER_CHECK_FAIL = "ORDER_CHECK_FAIL";
export const ORDER_CHECK_RESET = "ORDER_CHECK_RESET";
...
//Revenue
export const REVENUE_LISTBYDATE_REQUEST = "REVENUE_LISTBYDATE_REQUEST";
export const REVENUE_LISTBYDATE_SUCCESS = "REVENUE_LISTBYDATE_SUCCESS";
export const REVENUE_LISTBYDATE_FAIL = "REVENUE_LISTBYDATE_FAIL";
export const REVENUE_LISTBYDATE_RESET = "REVENUE_LISTBYDATE_RESET";

export const REVENUE_LISTBYMONTH_REQUEST = "REVENUE_LISTBYMONTH_REQUEST";
export const REVENUE_LISTBYMONTH_SUCCESS = "REVENUE_LISTBYMONTH_SUCCESS";
export const REVENUE_LISTBYMONTH_FAIL = "REVENUE_LISTBYMONTH_FAIL";
export const REVENUE_LISTBYMONTH_RESET = "REVENUE_LISTBYMONTH_RESET";

export const REVENUE_ALISTBYMONTH_REQUEST = "REVENUE_ALISTBYMONTH_REQUEST";
export const REVENUE_ALISTBYMONTH_SUCCESS = "REVENUE_ALISTBYMONTH_SUCCESS";
export const REVENUE_ALISTBYMONTH_FAIL = "REVENUE_ALISTBYMONTH_FAIL";
export const REVENUE_ALISTBYMONTH_RESET = "REVENUE_ALISTBYMONTH_RESET";

export const PRODUCTBEST_LIST_REQUEST = "PRODUCTBEST_LIST_REQUEST";
export const PRODUCTBEST_LIST_SUCCESS = "PRODUCTBEST_LIST_SUCCESS";
export const PRODUCTBEST_LIST_FAIL = "PRODUCTBEST_LIST_FAIL";
...
export const VOUCHER_DETAILS_STOP = "VOUCHER_DETAILS_STOP";
...
export const VOUCHER_SEARCH_REQUEST = "VOUCHER_SEARCH_REQUEST";
export const VOUCHER_SEARCH_SUCCESS = "VOUCHER_SEARCH_SUCCESS";
export const VOUCHER_SEARCH_FAIL = "VOUCHER_SEARCH_FAIL";

//Paypal
export const PAYPAL_LIST_REQUEST = "PAYPAL_LIST_REQUEST";
export const PAYPAL_LIST_SUCCESS = "PAYPAL_LIST_SUCCESS";
export const PAYPAL_LIST_FAIL = "PAYPAL_LIST_FAIL";

export const PAYPAL_DETAIL_REQUEST = "PAYPAL_DETAIL_REQUEST";
export const PAYPAL_DETAIL_SUCCESS = "PAYPAL_DETAIL_SUCCESS";
export const PAYPAL_DETAIL_FAIL = "PAYPAL_DETAIL_FAIL";
export const PAYPAL_DETAIL_RESET = "PAYPAL_DETAIL_RESET";

export const PAYPAL_REFUND_REQUEST = "PAYPAL_REFUND_REQUEST";
export const PAYPAL_REFUND_SUCCESS = "PAYPAL_REFUND_SUCCESS";
export const PAYPAL_REFUND_FAIL = "PAYPAL_REFUND_FAIL";
export const PAYPAL_REFUND_RESET = "PAYPAL_REFUND_RESET";

//DataNumber
export const DATANUMBER_DETAILS_REQUEST = "DATANUMBER_DETAILS_REQUEST";
export const DATANUMBER_DETAILS_SUCCESS = "DATANUMBER_DETAILS_SUCCESS";
export const DATANUMBER_DETAILS_FAIL = "DATANUMBER_DETAILS_FAIL";
export const DATANUMBER_DETAILS_STOP = "DATANUMBER_DETAILS_STOP";

export const DATANUMBER_UPDATE_REQUEST = "DATANUMBER_UPDATE_REQUEST";
export const DATANUMBER_UPDATE_SUCCESS = "DATANUMBER_UPDATE_SUCCESS";
export const DATANUMBER_UPDATE_FAIL = "DATANUMBER_UPDATE_FAIL";
export const DATANUMBER_UPDATE_RESET = "DATANUMBER_UPDATE_RESET";